...
public class Utilidad {
   ...
   private static final String RUTA_ARCHIVO = "c:/archivo_verinaria/";
   ...
   private static Gato asignarAtributosGato(String[] atributos){
      ...
      gato.setGarras(Boolean.parseBoolean(atributos[6]));
      gato.setPelo(Boolean.parseBoolean(atributos[7]));
      return gato; 
   }
